        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Master Plumber • Member since 2022</p>
            </div>
          </div>
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="w-6 h-6 rounded-full bg-yellow-400 text-white text-xs flex items-center justify-center font-semibold">1</span>
              </div>
              <div className="bg-white rounded-xl p-4 shadow-sm flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">22 Dizengoff St, Tel Aviv</p>
                  <span className="inline-block mt-2 text-xs bg-gray-100 text-gray-600 rounded-full px-3 py-1">On the way</span>
                </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h2 className="font-semibold text-gray-800">New Job Requests</h2>
                <span className="text-xs bg-blue-500 text-white rounded-full px-3 py-1">3 New</span>
              </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-semibold text-gray-800">Emergency Pipe Leak</span>
                        <span className="text-xs bg-red-100 text-red-500 rounded-full px-2 py-0.5">Emergency</span>
                        <span className="text-xs bg-blue-100 text-blue-500 rounded-full px-2 py-0.5">plumbing</span>
                      </div>
                      <p className="text-sm text-gray-500">Sarah Jenkins</p>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold text-orange-500">€120 - €150</p>
                      <p className="text-xs text-gray-400">Estimated</p>
                    </div>
                  </div>

                  <div className="bg-gray-50 rounded-lg px-4 py-3 mb-4 text-sm text-gray-600 italic">
                    "Water leaking rapidly under kitchen sink. Need someone immediately."
                  </div>
            ...
            <div className="space-y-3">
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <p className="font-semibold text-gray-800 text-sm">John Smith</p>
                  <p className="text-xs text-gray-400">2 days ago</p>
                </div>
                <StarRating rating={5} />
                <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                  "Mike was fantastic. Arrived on time, fixed the issue quickly, and left the place clean."
                </p>
              </div>

              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <p className="font-semibold text-gray-800 text-sm">Lisa Wong</p>
                  <p className="text-xs text-gray-400">1 week ago</p>
                </div>
                <StarRating rating={5} />
                <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                  "Very professional and reasonably priced. Will definitely hire again for future plumbing needs."
                </p>
              </div>
