...
import { FaChartLine, FaCheck, FaEye } from "react-icons/fa";

export default function ViolationMomentumModal({ open, onCancel }: ModalProps) {
  return (
    <Modal
      open={open}
      onCancel={onCancel}
      ...
      <div className="py-2">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-1">
              Violation Momentum Index (VMI)
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">VMI</p>
          </div>
        </div>

        {/* Quote */}
        <div className="bg-yellow-50 dark:bg-yellow-950/30 border-l-4 border-yellow-500 px-4 py-3 mb-6">
          <p className="text-sm italic text-yellow-700 dark:text-yellow-300">
            Are your mistakes isolated — or snowballing?
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2 text-sm text-slate-700 dark:text-slate-300">
              ...
              <span>Clustering of mistakes</span>
            </li>
            <li className="flex items-start gap-2 text-sm text-slate-700 dark:text-slate-300">
              <FaCheck className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5 shrink-0" />
              <span>Acceleration of violations</span>
            </li>
            <li className="flex items-start gap-2 text-sm text-slate-700 dark:text-slate-300">
              <FaCheck className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5 shrink-0" />
              <span>Snowball effect detection</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-slate-700 dark:text-slate-300">
            Weighted score based on time between violations. Closer violations =
            higher VMI.
          </p>
        </div>
        ...
        <div className="bg-cyan-50 dark:bg-cyan-950/20 border border-cyan-200 dark:border-cyan-800 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-slate-700 dark:text-slate-300">
            Rising VMI → session downgrade. Falling VMI → unlocks privileges.
          </p>
        </div>
