...
export default function ConfidenceAccuracyModal({
  open,
  onCancel,
}: ModalProps) {
  return (
      ...
      <div className="p-2 rounded-3xl md:rounded-4xl overflow-hidden transition-all duration-300">
        <div className="flex justify-between items-start mb-8">
          <div className="flex gap-4">
            <div className="bg-orange-100 dark:bg-orange-900/30 p-3.5 rounded-2xl text-orange-600 shrink-0">
        ...
        <div className="bg-orange-50/50 dark:bg-orange-950/20 border-l-4 border-orange-500 p-5 rounded-r-2xl mb-8">
          <p className="text-base italic font-medium text-orange-800 dark:text-orange-300">
            Is your confidence aligned with reality?
          </p>
        </div>
        ...
        <div className="space-y-6 mb-8">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm font-bold text-slate-600 dark:text-slate-400">
                <IoCheckmarkCircle className="text-emerald-500 text-lg shrink-0" />
                Underconfidence opportunity loss
              </li>
            </ul>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800/30 p-5 rounded-2xl">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-300 font-medium">
              Correlation between pre-trade confidence rating and actual
              outcome.
            </p>
          </div>
          ...
          <div className="bg-cyan-50 dark:bg-cyan-900/10 border border-cyan-100 dark:border-cyan-800/30 p-5 rounded-2xl">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-300 font-medium">
              Your highest confidence trades underperform by 18%.
            </p>
          </div>
        </div>
