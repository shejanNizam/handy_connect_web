...
export default function DisciplineAdjustedExpectancyModal({
  open,
  onCancel,
}: ModalProps) {
  return (
      ...
      <div className="p-2 rounded-3xl md:rounded-4xl overflow-hidden transition-all duration-300">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white leading-tight">
                Discipline-Adjusted Expectancy
              </h2>
        ...
        <div className="bg-blue-50/50 dark:bg-blue-950/20 border-l-4 border-blue-500 p-5 rounded-r-2xl mb-8">
          <p className="text-base italic font-medium text-blue-800 dark:text-blue-300">
            Your true edge after removing undisciplined trades.
          </p>
        </div>
        ...
        <div className="text-center py-8 mb-8 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 rounded-3xl shadow-sm">
          ...
          <div className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter flex items-center justify-center gap-4">
            <span>₹2,450</span>
            <span className="text-xl md:text-3xl opacity-30 font-medium">
              vs
            </span>
        ...
        <div className="space-y-6 mb-8">
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm font-bold text-slate-600 dark:text-slate-400">
                ...
                Raw expectancy vs disciplined-only expectancy
              </li>
              <li className="flex items-center gap-3 text-sm font-bold text-slate-600 dark:text-slate-400">
                <IoCheckmarkCircle className="text-emerald-500 text-lg shrink-0" />
                True edge when following rules
              </li>
              <li className="flex items-center gap-3 text-sm font-bold text-slate-600 dark:text-slate-400">
                <IoCheckmarkCircle className="text-emerald-500 text-lg shrink-0" />
                Cost of indiscipline in expectancy terms
              </li>
            </ul>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800/30 p-5 rounded-2xl">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-300 font-medium leading-relaxed">
              Expectancy of trades where all rules were followed.
            </p>
          </div>
          ...
          <div className="bg-cyan-50 dark:bg-cyan-900/10 border border-cyan-100 dark:border-cyan-800/30 p-5 rounded-2xl">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-300 font-medium">
              You are profitable only when disciplined. Raw expectancy: ₹890.
              Disciplined: ₹2,450.
            </p>
          </div>
        </div>
